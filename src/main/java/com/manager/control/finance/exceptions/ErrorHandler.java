...
public class ErrorHandler {
    ...
    public ResponseEntity<ResponseMessage> errorHandlerDataIntegrityViolation(){
        ResponseMessage error = new ResponseMessage(GlobalMessages.DATA_INTEGRITY_VIOLATION);
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
}
